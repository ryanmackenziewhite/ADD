...
Based on concepts applied to retail Scanner Data (CPI / Retail division) 
Goal(s) 
...
Data Processing Summary from Stan Hatko
...
3. Map 
    ...
    Map MCH0 to NAPCS, add NAPCS column to msgpack input pd.
    Store any missing NAPCS codes from MCH0.
    Add regional sales columns to pd.
    Add brand sales to pd.
    Groupby NAPCS and sum, store to output.
